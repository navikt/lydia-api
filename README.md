...
<!-- TODO: Beskriv prosessen for å generere og laste opp nye test-virksomheter -->
...
Lydia-api mottar ny statistikk via Kafka. Denne produseres av [pia-sykefravarsstatistikk](https://github.com/navikt/pia-sykefravarsstatistikk) som igjen produseres av [pia-dvh-import](https://github.com/navikt/pia-dvh-import).

### Testdata i dev-miljø for nytt kvartal
Testdata må produseres og lagres i bucket slik vi kan importere de med pia-dvh-import.
<!-- TODO: Beskriv prosessen for å generere og laste opp testdata -->

### Import av nytt kvartal
Dette krever noe vedlikehold for å holde appen oppdatert:
1. Importer nytt kvartal med sykefraværsstatistikk ved å kjøre import jobb med [pia-jobbsender](https://github.com/navikt/pia-jobbsender/actions/workflows/deploy.yaml). Dette vil gjøre at [pia-dvh-import](https://github.com/navikt/pia-dvh-import) importerer nylig publisert statistikk fra Bucket. (For dev se [her](#testdata-i-dev-miljø))
...
<!-- TODO: Usikker på om dette fortsatt gjelder, Har ikke fått dette til å virke? -->
