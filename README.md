...
## Kjøre container-tester i IntelliJ

For at prosjektet skal bygges før testene kjøres må man legge til Gradle-tasken `shadowJar` i testkonfigurasjonen i IntelliJ.

Se `.run/Kjør tester.run.xml` for et eksempel. 
