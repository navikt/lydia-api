...
6. Ta vare på filen som lastes ned og legg i en mappe som f.eks. `lydia-api/scripts/tenor/data/<fylke>/<primærnæring>/<din_nye_fil>.json`
7. Kjør `python3 main.py` for å generere SQL-scripts. Det opprettes flere i output mappen `tenor/sql_scripts/` som følger samme mappestruktur som input.
