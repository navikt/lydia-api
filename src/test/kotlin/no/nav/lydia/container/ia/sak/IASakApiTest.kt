...
import no.nav.lydia.abc.samarbeidsperiode.BegrunnelseType.VIRKSOMHETEN_HAR_FOR_LAVT_POTENSIALE
import no.nav.lydia.abc.samarbeidsperiode.BegrunnelseType.VIRKSOMHETEN_MANGLER_REPRESANTANTER_ELLER_ETABLERT_PARTSGRUPPE
import no.nav.lydia.abc.samarbeidsperiode.IASak
import no.nav.lydia.abc.samarbeidsperiode.IASakLeveranseStatus
import no.nav.lydia.abc.samarbeidsperiode.IASakshendelseType.OPPRETT_SAK_FOR_VIRKSOMHET
import no.nav.lydia.abc.samarbeidsperiode.IASakshendelseType.VIRKSOMHET_VURDERES
import no.nav.lydia.abc.samarbeidsperiode.IASakshendelseType.VURDERING_FULLFØRT_UTEN_SAMARBEID
import no.nav.lydia.abc.samarbeidsperiode.ValgtÅrsak
import no.nav.lydia.abc.samarbeidsperiode.ÅrsakTilAtSakIkkeKanAvsluttes
import no.nav.lydia.abc.samarbeidsperiode.ÅrsakType.VIRKSOMHETEN_ER_FERDIG_VURDERT_MED_INTERN_VURDERING
import no.nav.lydia.abc.samarbeidsperiode.ÅrsaksType
