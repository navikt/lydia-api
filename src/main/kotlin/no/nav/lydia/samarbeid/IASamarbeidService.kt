...
import no.nav.lydia.dokumentpublisering.arbeidsgiver.SamarbeidMedDokumenterDto
import no.nav.lydia.felles.Feil
import no.nav.lydia.kartlegging.Spørreundersøkelse
import no.nav.lydia.kartlegging.SpørreundersøkelseRepository
import no.nav.lydia.samarbeid.IASamarbeidService.StatusendringBegrunnelser.AKTIV_BEHOVSVURDERING
import no.nav.lydia.samarbeid.IASamarbeidService.StatusendringBegrunnelser.AKTIV_EVALUERING
import no.nav.lydia.samarbeid.IASamarbeidService.StatusendringBegrunnelser.FINNES_BEHOVSVURDERING
import no.nav.lydia.samarbeid.IASamarbeidService.StatusendringBegrunnelser.FINNES_EVALUERING
import no.nav.lydia.samarbeid.IASamarbeidService.StatusendringBegrunnelser.FINNES_SALESFORCE_AKTIVITET
import no.nav.lydia.samarbeid.IASamarbeidService.StatusendringBegrunnelser.FINNES_SAMARBEIDSPLAN
import no.nav.lydia.samarbeid.IASamarbeidService.StatusendringBegrunnelser.INGEN_EVALUERING
import no.nav.lydia.samarbeid.IASamarbeidService.StatusendringBegrunnelser.INGEN_PLAN
import no.nav.lydia.samarbeid.IASamarbeidService.StatusendringBegrunnelser.SAK_I_FEIL_STATUS
