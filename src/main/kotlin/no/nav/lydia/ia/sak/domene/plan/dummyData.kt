...
fun getHardkodetPlan(): Plan = Plan(
    id = hardkodetPlanId,
    publisert = false,
...
fun ettPåbegyntTema(): List<PlanTema> = listOf(
    PlanTema(
        id = 1,
        navn = "Sykefraværsarbeid",
        undertemaer = sykefraværsarbeidPåbegynt,
        ressurser = hardkodedeRessurser, planlagt = false,
    ),
    PlanTema(
        id = 2,
        navn = "Partssamarbeid",
        undertemaer = partssamarbeidIkkeValgt,
        ressurser = emptyList(), planlagt = false,
    ),
    PlanTema(
        id = 3,
        navn = "Arbeidsmiljø",
...
val sykefraværsrutinerInaktiv = PlanUndertema(
    id = 1,
    navn = "Sykefraværsrutiner",
    målsetning = dummyMålsetning,
    beskrivelse = dummyBeskrivelse,
    planlagt = false,
    startDato = null,
    sluttDato = null,
    status = null
...
val oppfølgingssamtalerInaktiv = PlanUndertema(
    id = 2,
...
val tilretteleggingOgMedvirkningspliktInaktiv = PlanUndertema(
    id = 3,
...
val gjentagendeSykefraværInaktiv = PlanUndertema(
    id = 4,
...
val UtviklePartssamarbeidetInaktiv = PlanUndertema(
    id = 5,
...
val arbeidsmiljølovenInaktiv = PlanUndertema(
    id = 6,
...
val medbestemmelseInaktiv = PlanUndertema(
    id = 7,
    navn = "Medbestemmelse",
    målsetning = dummyMålsetning,
    beskrivelse = dummyBeskrivelse,
...
val medvirkningInaktiv = PlanUndertema(
    id = 8,
    navn = "Medvirkning",
    målsetning = dummyMålsetning,
    beskrivelse = dummyBeskrivelse,
