...
class BrregDownloader(
    val url: String = "https://data.brreg.no/enhetsregisteret/api/enheter/lastned",
    val virksomhetRepository: VirksomhetRepository
) {
    companion object {
        const val enhetApplicationType = "application/vnd.brreg.enhetsregisteret.enhet.v1+gzip;charset=UTF-8"
    }
    ...
    fun lastNed() {
        val request =
            url.httpGet()
        request[Headers.ACCEPT] = enhetApplicationType
