...
import no.nav.lydia.prioritering.sykefraværsstatistikk.api.Sorteringsnøkkel
import no.nav.lydia.prioritering.sykefraværsstatistikk.api.Sorteringsnøkkel.ANTALL_PERSONER
import no.nav.lydia.prioritering.sykefraværsstatistikk.api.Sorteringsnøkkel.MULIGE_DAGSVERK
import no.nav.lydia.prioritering.sykefraværsstatistikk.api.Sorteringsnøkkel.NAVN_PÅ_VIRKSOMHET
import no.nav.lydia.prioritering.sykefraværsstatistikk.api.Sorteringsnøkkel.SIST_ENDRET
import no.nav.lydia.prioritering.sykefraværsstatistikk.api.Sorteringsnøkkel.SYKEFRAVÆRSPROSENT
import no.nav.lydia.prioritering.sykefraværsstatistikk.api.Sorteringsnøkkel.TAPTE_DAGSVERK
...
import no.nav.lydia.prioritering.sykefraværsstatistikk.api.Søkeparametere.Companion.filtrerPåSnitt
import no.nav.lydia.prioritering.sykefraværsstatistikk.api.Søkeparametere.Companion.filtrerPåTilstand
import no.nav.lydia.prioritering.sykefraværsstatistikk.domene.Statistikkdata
