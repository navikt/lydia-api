package no.nav.lydia.prioritering.sykefraværsstatistikk
...
import no.nav.lydia.prioritering.sykefraværsstatistikk.import.BehandletBransjeSykefraværsstatistikk
import no.nav.lydia.prioritering.sykefraværsstatistikk.import.BehandletImportMetadataVirksomhet
import no.nav.lydia.prioritering.sykefraværsstatistikk.import.BehandletKvartalsvisSykefraværsstatistikk
import no.nav.lydia.prioritering.sykefraværsstatistikk.import.BehandletLandSykefraværsstatistikk
import no.nav.lydia.prioritering.sykefraværsstatistikk.import.BehandletNæringSykefraværsstatistikk
import no.nav.lydia.prioritering.sykefraværsstatistikk.import.BehandletNæringsundergruppeSykefraværsstatistikk
import no.nav.lydia.prioritering.sykefraværsstatistikk.import.BehandletSektorSykefraværsstatistikk
import no.nav.lydia.prioritering.sykefraværsstatistikk.import.BehandletVirksomhetSykefraværsstatistikk
import no.nav.lydia.prioritering.sykefraværsstatistikk.import.BehandletVirksomhetSykefraværsstatistikkSiste4Kvartal
...
import no.nav.lydia.prioritering.sykefraværsstatistikk.import.SykefraværsstatistikkPerKategoriImportDto.Companion.tilBehandletBransjeSykefraværsstatistikk
import no.nav.lydia.prioritering.sykefraværsstatistikk.import.SykefraværsstatistikkPerKategoriImportDto.Companion.tilBehandletLandSykefraværsstatistikk
import no.nav.lydia.prioritering.sykefraværsstatistikk.import.SykefraværsstatistikkPerKategoriImportDto.Companion.tilBehandletNæringSykefraværsstatistikk
import no.nav.lydia.prioritering.sykefraværsstatistikk.import.SykefraværsstatistikkPerKategoriImportDto.Companion.tilBehandletNæringsundergruppeSykefraværsstatistikk
import no.nav.lydia.prioritering.sykefraværsstatistikk.import.SykefraværsstatistikkPerKategoriImportDto.Companion.tilBehandletSektorSykefraværsstatistikk
import no.nav.lydia.prioritering.sykefraværsstatistikk.import.SykefraværsstatistikkPerKategoriImportDto.Companion.tilBehandletVirksomhetSykefraværsstatistikk
import no.nav.lydia.prioritering.sykefraværsstatistikk.import.SykefraværsstatistikkPerKategoriImportDto.Companion.tilBehandletVirksomhetSykefraværsstatistikkSiste4Kvartal
import no.nav.lydia.prioritering.sykefraværsstatistikk.import.tilBehandletImportGradertSykmelding
import no.nav.lydia.prioritering.sykefraværsstatistikk.import.tilBehandletImportGradertSykmeldingSiste4Kvartal
...
class SykefraværsstatistikkRepository(
    ...
    fun insertSykefraværsstatistikkForSisteGjelendeKvartalForLand(sykefraværsstatistikk: List<SykefraværsstatistikkPerKategoriImportDto>) {
        using(sessionOf(dataSource)) { session ->
    ...
    fun insertSykefraværsstatistikkForSisteGjelendeKvartalForSektor(sykefraværsstatistikk: List<SykefraværsstatistikkPerKategoriImportDto>) {
        using(sessionOf(dataSource)) { session ->
            session.transaction { tx ->
    ...
    fun insertSykefraværsstatistikkForSisteGjelendeKvartalForBransje(sykefraværsstatistikk: List<SykefraværsstatistikkPerKategoriImportDto>) {
        using(sessionOf(dataSource)) { session ->
            session.transaction { tx ->
    ...
    fun insertSykefraværsstatistikkForSisteGjelendeKvartalForNæring(sykefraværsstatistikk: List<SykefraværsstatistikkPerKategoriImportDto>) {
        using(sessionOf(dataSource)) { session ->
            session.transaction { tx ->
    ...
    fun insertSykefraværsstatistikkForSisteGjelendeKvartalForNæringskode(sykefraværsstatistikk: List<SykefraværsstatistikkPerKategoriImportDto>) {
        using(sessionOf(dataSource)) { session ->
            session.transaction { tx ->
                tx.insertBehandletNæringsundergruppeStatistikk(
                    behandletNæringsundergruppeSykefraværsstatistikk =
                        sykefraværsstatistikk.tilBehandletNæringsundergruppeSykefraværsstatistikk(),
                )
            }
        }
    }

    fun insertSykefraværsstatistikkForSisteGjelendeKvartalForVirksomhet(sykefraværsstatistikk: List<SykefraværsstatistikkPerKategoriImportDto>) {
        using(sessionOf(dataSource)) { session ->
            session.transaction { tx ->
    ...
    fun insertStatistikkVirksomhetGraderingSiste4Kvartal(gradertSykemeldingImportDtoList: List<GradertSykemeldingImportDto>) =
        using(sessionOf(dataSource)) { session ->
            session.transaction { tx ->
    ...
    fun insertStatistikkVirksomhetGraderingGjeldendeKvartal(gradertSykemeldingImportDtoList: List<GradertSykemeldingImportDto>) =
        using(sessionOf(dataSource)) { session ->
            session.transaction { tx ->
    ...
    fun insertSykefraværsstatistikkForSiste4KvartalerForAndreKategorier(sykefraværsstatistikk: List<SykefraværsstatistikkPerKategoriImportDto>) =
        using(sessionOf(dataSource)) { session ->
            session.transaction { tx ->
    ...
    fun insertSykefraværsstatistikkForSiste4KvartalerForVirksomhet(sykefraværsstatistikk: List<SykefraværsstatistikkPerKategoriImportDto>) =
        using(sessionOf(dataSource)) { session ->
            session.transaction { tx ->
                tx.insertVirksomhetsstatistikkSiste4Kvartal(
                    behandletVirksomhetSykefraværsstatistikkSiste4KvartalListe =
                        sykefraværsstatistikk.tilBehandletVirksomhetSykefraværsstatistikkSiste4Kvartal(),
                )
            }
        }
    ...
    fun insertMetadataForVirksomhet(virksomhetMetadata: List<BehandletImportMetadataVirksomhet>) =
        using(sessionOf(dataSource)) { session ->
            session.transaction { tx ->
    ...
    private fun BehandletKvartalsvisSykefraværsstatistikk.tilStatistikkSpesifikkVerdi() =
        when (this) {
    ...
    private fun TransactionalSession.insertBehandletBransjeStatistikk(
        behandletBransjeSykefraværsstatistikk: Collection<BehandletBransjeSykefraværsstatistikk>,
    ) = insertBehandletSykefraværsstatistikk(
    ...
    private fun mapRowToSiste4Kvartal(row: Row) =
        Siste4Kvartal(
    ...
    private fun mapRowToSistePubliserteKvartal(row: Row) =
    ...
    private fun mapRowToNæringSykefraværsstatistikk(row: Row) =
        NæringSykefraværsstatistikk(
    ...
    private fun mapRowToBransjeSykefraværsstatistikk(row: Row) =
        BransjeSykefraværsstatistikk(
