...
import no.nav.lydia.prioritering.sykefraværsstatistikk.api.KvartalerFraTilDto
...
import no.nav.lydia.prioritering.sykefraværsstatistikk.domene.KategoriStatistikk
import no.nav.lydia.prioritering.sykefraværsstatistikk.domene.NæringSykefraværsstatistikk
import no.nav.lydia.prioritering.sykefraværsstatistikk.domene.Virksomhetsoversikt
import no.nav.lydia.prioritering.sykefraværsstatistikk.domene.VirksomhetsstatistikkSiste4Kvartal
...
import no.nav.lydia.prioritering.sykefraværsstatistikk.import.Kategori.BRANSJE
import no.nav.lydia.prioritering.sykefraværsstatistikk.import.Kategori.LAND
import no.nav.lydia.prioritering.sykefraværsstatistikk.import.Kategori.NÆRING
import no.nav.lydia.prioritering.sykefraværsstatistikk.import.Kategori.NÆRINGSKODE
import no.nav.lydia.prioritering.sykefraværsstatistikk.import.Kategori.SEKTOR
...
import no.nav.lydia.prioritering.sykefraværsstatistikk.import.SykefraværsstatistikkPerKategoriImportDto.Companion.mapSektorNavnTilSektorKode
...
class SykefraværsstatistikkService(
    ...
    fun lagreStatistikkMetadataVirksomhet(behandletImportMetadataVirksomhetListe: List<BehandletImportMetadataVirksomhet>) {
        ...
        log.info(
            "Brukte ${System.currentTimeMillis() - start} ms på å lagre ${behandletImportMetadataVirksomhetListe.size} virksomhet metadata",
        )
    }
    ...
    fun lagreSykefraværsstatistikkPerKategori(sykefraværsstatistikkKategoriImportDtoListe: List<SykefraværsstatistikkPerKategoriImportDto>) {
        ...
        log.info(
            "Brukte ${System.currentTimeMillis() - start} ms på å lagre ${sykefraværsstatistikkKategoriImportDtoListe.size} statistikkmeldinger per kategori",
        )
    }
    ...
    fun søkEtterVirksomheter(søkeparametere: Søkeparametere): List<Virksomhetsoversikt> {
        val start = System.currentTimeMillis()
...
class KvartalerFraTil(
    val fra: Kvartal,
    val til: Kvartal,
) {
    fun toDto(): KvartalerFraTilDto = KvartalerFraTilDto(fra = fra.toDto(), til = til.toDto())
}
