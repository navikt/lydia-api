...
object VirksomhetVurderes : Tilstand() { // VURDERES
    override fun utførTransisjon(
        ...
        when (hendelse) {
            ...
            is AvsluttSamarbeid, is EndrePlanlagtDatoForNesteTilstand, is EndreSamarbeidsNavn, is EndreStatusPåUndertemaISamarbeidsplan,
            is FullførKartleggingForSamarbeid, is GjørVirksomhetKlarTilNyVurdering, is OppdaterPlanForSamarbeid, is OppdaterTemaIPlanForSamarbeid,
            is OpprettKartleggingForSamarbeid, is OpprettPlanForSamarbeid, is SlettKartleggingForSamarbeid, is SlettPlanForSamarbeid, is SlettSamarbeid,
            is StartKartleggingForSamarbeid, is VurderVirksomhet,
            -> {
                Either.Left(
