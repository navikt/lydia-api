...
import no.nav.lydia.kartlegging.TemaInfo
...
import no.nav.lydia.samarbeid.MAKS_ANTALL_TEGN_I_SAMARBEIDSNAVN
...
import no.nav.lydia.samarbeidsplan.PlanService.Companion.erGyldig
...
class NyFlytService(
    ...
    fun validerEndringAvPlanlagtDatoForNesteTilstand(
        ...
        either {
            ...
            ensure(nyPlanlagtDato.isAfter(LocalDate.now())) {
                Feil(
