...
import no.nav.fia.ia.sak.api.IASakDto.Companion.toDto
import no.nav.fia.ia.sak.api.IASakshendelseOppsummeringDto.Companion.toDto
import no.nav.fia.tilgangskontroll.Rådgiver.Companion.somBrukerMedLesetilgang
import no.nav.fia.tilgangskontroll.Rådgiver.Companion.somBrukerMedSaksbehandlertilgang
import no.nav.fia.tilgangskontroll.Rådgiver.Companion.somSuperbruker
